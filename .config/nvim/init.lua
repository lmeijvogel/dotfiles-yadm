...
vim.keymap.set('n', '<M-Up>', '<C-w>8+', { desc = 'Make split taller' })
vim.keymap.set('n', '<M-Down>', '<C-w>8-', { desc = 'Make split less tall' })
vim.keymap.set('n', '<M-Left>', '<C-w>8<', { desc = 'Make split more narrow' })
vim.keymap.set('n', '<M-Right>', '<C-w>8>', { desc = 'Make split wider' })

vim.keymap.set('n', '<M-S-Up>', '<C-w>+', { desc = 'Make split taller (1 line)' })
vim.keymap.set('n', '<M-S-Down>', '<C-w>-', { desc = 'Make split less tall (1 line)' })
vim.keymap.set('n', '<M-S-Left>', '<C-w><', { desc = 'Make split more narrow (1 col)' })
vim.keymap.set('n', '<M-S-Right>', '<C-w>>', { desc = 'Make split wider (1 col)' })
...
vim.keymap.set('n', '<C-A-n>', ':cn<CR>', { desc = 'Next search result' })
vim.keymap.set('n', '<C-A-p>', ':cp<CR>', { desc = 'Previous search result' })

-- Navigate through git conflict markers a bit more easily
vim.keymap.set('n', '<leader>m', '/^<<<<<<<\\|^|||||||\\|^=======\\|^>>>>>>>/<CR>', { desc = 'Find conflict markers' })
vim.keymap.set('x', '<leader>m', '/^<<<<<<<\\|^|||||||\\|^=======\\|^>>>>>>>/<CR>', { desc = 'Find conflict markers' })
...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- By default, the git branch is shown in the status line, but
      -- I have that in my taskbar already.
      ---@diagnostic disable-next-line: duplicate-set-field
